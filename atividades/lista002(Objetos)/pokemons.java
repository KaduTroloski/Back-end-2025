...
public class pokemons {
     ...
     public void gerarPokemon() {
    String[] todosOsTipos = {"Normal","Fogo","Água","Planta","Elétrico","Gelo","Lutador","Venenoso","Terrestre","Voador","Psíquico","Inseto","Pedra","Fantasma","Dragão","Aço","Sombrio"};
    String[] pokemons = {
    ...
    "Ho-Oh", "Celebi", "Treecko", "Grovyle", "Sceptile", "Torchic", "Combusken", "Blaziken",
    ...
    "Volbeat", "Illumise", "Roselia", "Gulpin", "Swoobat", "Carvanha", "Sharpedo",
    ...
    String nomePokemon = pokemons[this.randomIndex(pokemons)];
    String tipoPokemon = todosOsTipos[this.randomIndex(todosOsTipos)];
    int levelPokemon = this.randomLevel();

    System.out.printf("%s, é um pokemon do tipo %s e esta no nivel: %s.%n",
                    nomePokemon,
                    tipoPokemon,
                    levelPokemon, '\n');
	}
    ...
    int randomAge = rd.nextInt(1, 100);
    return randomAge;
    }
